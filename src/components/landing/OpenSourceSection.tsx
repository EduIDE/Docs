...
const contributions: Contribution[] = [
  ...
  { color: "#4E9F9C", text: "Git Action button support" },
...
export default function OpenSourceSection() {
  ...
  const theiaLogo = useBaseUrl("/img/theia.svg");
        ...
        <div className={styles.ossTheiaProminent}>
          <div className={styles.ossTheiaLeft}>
            <div className={styles.ossTheiaBadge} aria-hidden="true">
              <img src={theiaLogo} alt="Eclipse Theia logo" />
            </div>
            <div>
              ...
              <p className={styles.ossTheiaDesc}>
                EduIDE is built on Eclipse Theia, the same robust, open-source framework behind many professional cloud IDEs.
                Through our close collaboration with EclipseSource, we leverage a highly scalable foundation and actively contribute our educational extensions back to the upstream community.
              </p>
              <a
